...
export const metadata: Metadata = {
  title: "Verdant — Mood 01 · Kummer Gartenbau",
...
const shots = {
  hero: img("1466692476868-aef1dfb1e735", 2000, 1300),
  a: img("1416879595882-3373a0480b5b", 900, 1200),
  b: img("1518173946687-a4c8892bbd9f", 900, 700),
        ...
        <section class="relative h-screen min-h-[640px] w-full overflow-hidden">
          ...
          <div class="relative z-10 flex h-full flex-col justify-end px-6 sm:px-10 lg:px-16 pb-20">
            ...
            >
              ...
              späten Sonne. Ein Stimmungsbild für Farbe, Schrift und Bild.
            </p>
          </div>
        ...
        <section class="px-6 sm:px-10 lg:px-16 py-24 lg:py-32 max-w-7xl">
          ...
          >
            ...
            <div class="rounded-2xl border border-mustard-200 bg-mustard-50 p-7">
              <span class="kicker text-[10px] text-stone-500">Auf Senf</span>
            ...
            >
              ...
              <div>
                ...
                <p class="text-stone-500 text-sm mt-5">
                  Beschriftungen ruhen auf hellem Grün — die Farbe kommt aus
