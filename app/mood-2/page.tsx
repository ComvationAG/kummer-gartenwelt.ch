        ...
        <section class="px-6 sm:px-10 lg:px-16 py-24 lg:py-32 max-w-7xl">
          ...
          <div class="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div class="reveal" style="animation-delay:240ms">
              <span class="inline-flex items-center gap-2 rounded-full border border-olive-bark-200 bg-olive-bark-50 px-3 py-1">
                <span class="block w-2 h-2 rounded-full bg-olive-bark-500" />
                <span class="kicker text-[10px] text-olive-bark-700">Aussenraum</span>
              </span>
              ...
              <div class="mt-6 flex items-center gap-2">
                ...
                <span class="inline-block w-5 h-5 rounded-full bg-olive-bark-500" />
                <span class="text-stone-500 text-sm ml-2">
                  India Green + Olive Bark
                </span>
              </div>
